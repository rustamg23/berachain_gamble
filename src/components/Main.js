  ...
  return (
    ...
    <div className="xl:flex xl:flex-row grid grid-rows-2 justify-around items-center w-svw h-lvh bg " >
      <div className="max-w-2xl text-left xl:space-y-8 space-y-6 xl:-ml-32 m-5 xl:relative xl:h-auto flex flex-col h-90p ">
        ...
        <p className='text-white poppins-font md:text-xl  text-sm font-normal xl:w-9/10 w-full xl:mb-auto ' style={{ textShadow: '3px 3px 2px rgba(0, 0, 0, 0.5)' }}>Welcome to the world of Junky Ursas! We, the high Ursas, are building an ecosystem of GambleFI projects on the Berachain. Get ready for a wild ride through a universe of decentralized fun led by a team as bold and adventurous as your favorite space-out bears!</p>
        <button className="poppins-font font-normal bg-red-500  text-white py-2 px-4 rounded-full xl:w-1/2 w-full text-2xl hover:bg-red-600 hover:scale-105 ease-in-out duration-500" {...buttonAHoverProps}>{buttonAIsHovering ? "SOON" : "GO TO APP"}</button>
